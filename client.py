...
def help():
    ...
    print("")
    print(
        "2) count(keys, dp): groupes the data by the given keys, and computes the count of submissions for each combination of those keys")
    ...
    print("")
    print(
        "You can import this file into your own python script using 'import client' and then use the above functions.")
