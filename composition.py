...
def expose(query_func):
    ...
    QUERY_TIMES = 200
    print("Making %d queries with noise. This may take a minute..." % QUERY_TIMES)
    ...
    for r in range(0, rows):
        # TODO: compute the actual value of row r, given all the noised values from making many queries.
        value = 0
        for i in range(len(many_results)):
            value += many_results[i][r][-1]
        value = round(value / QUERY_TIMES)
